...
public class HomeCareRequestActivity extends AppCompatActivity {
    ...
    EditText ed_name;
    @BindView(R.id.ed_preffereddate)
    EditText ed_preffereddate;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_home_care_request);
        ...
        ed_preffereddate.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            @Override
            public void onFocusChange(View view, boolean b) {
                if(b){
                    showDialog(9990);
    ...
    protected Dialog onCreateDialog(int id) {
        ...
        if (id == 999) {
            ...
            //  Toast.makeText(context, ""+calendar.getTime().getYear(), Toast.LENGTH_SHORT).show();
            return new DatePickerDialog(this,
                    myDateListenerPrefferedDate, calendar.get(Calendar.YEAR), calendar.get(Calendar.MONTH), calendar.get(Calendar.DATE));
        }
        return null;
    }
    ...
    private DatePickerDialog.OnDateSetListener myDateListenerPrefferedDate = new
            DatePickerDialog.OnDateSetListener() {
                @Override
                public void onDateSet(DatePicker arg0,
                                      int arg1, int arg2, int arg3) {
                    ...
                    // arg2 = month
                    // arg3 = day
                    dateInStringPrefDate = "" + arg1 + "-" + (arg2 + 1) + "-" + arg3;
                    //Toast.makeText(context, dateInStringPrefDate, Toast.LENGTH_SHORT).show();
                    ed_preffereddate.setText(dateInStringPrefDate);
                ...
                if(email.length()>0){
                    ...
                    if(address.length()>0) {
                        ...
                        if (phone.length() > 0) {
                            ...
                            request.put("birth_date", "0");
                            request.put("hospital_id",NOW_SHOWING_DOC.getHospitalId());
                            request.put("status", "1");
                            request.put("email", email);
                            request.put("home_address", address);
