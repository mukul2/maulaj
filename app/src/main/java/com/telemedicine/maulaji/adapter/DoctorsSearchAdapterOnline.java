...
public class DoctorsSearchAdapterOnline extends RecyclerView.Adapter<DoctorsSearchAdapterOnline.MyViewHolder> {
    ...
    public DoctorsSearchAdapterOnline(List<OnlineDoctorsModel> data) {
        this.list = data;
    }
